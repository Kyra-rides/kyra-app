...
// Connect to local Firestore emulator. The host is the laptop's LAN IP, which
// Expo already exposes through `Constants.expoConfig.hostUri` (= the Metro
// dev-server URL the phone is talking to right now).
